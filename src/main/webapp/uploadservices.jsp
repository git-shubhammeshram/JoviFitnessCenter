        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="upload-form">
                    <h2 class="mb-4">Services Form</h2>
                    <form action="uploadservice" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="instructorName">Service Name</label>
                            <input type="text" class="form-control" id="instructorName" name="sname" required>
                        </div>
                        <div class="form-group">
                            <label for="instagramId">Instructor Name</label>
                            <input type="text" class="form-control" id="instagramId" name="iname" required>
                        </div>
                        <div class="form-group">
                            <label for="instructorDetails">About Service</label>
